...
import net
import utils
import rbconf.conff as rbcfg  # 1.0.0.1
...
def runbasic(func, server_address=("0.0.0.0", 8080)):
    ...
    class WSGIHandler(SimpleHTTPServer.SimpleHTTPRequestHandler):
        ...
        def do_GET(self):
            if(rbcfg.isStaticPri(self.path)):
    ...
    # a=WSGIServer(func, server_address)  
    # a.shutdown()    ## 1.0.0.1
    rbcfg.WEB["server"]=WSGIServer(func, server_address) 
    rbcfg.WEB["server"].serve_forever()
    return
