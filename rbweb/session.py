...
class Store:
    ...
    def encode(self, session_dict):
        try:
            ...
            wlog.getLogger().debug(str(["encode session_data:",   session_dict,   pickled   ]))
    ...
    def decode(self, session_data):
        try:
            ...
            wlog.getLogger().debug(str(["decode session_data:",   session_data,   pickled   ]))
